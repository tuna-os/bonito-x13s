...
if command -v dnf &>/dev/null; then
    ...
    if [ ! -d /usr/lib/dracut/modules.d/70dmsquash-live ] && \
       [ ! -d /usr/lib/dracut/modules.d/90dmsquash-live ]; then
        ...
        cp -r /tmp/dracut-ng/modules.d/70dmsquash-live /usr/lib/dracut/modules.d/
        cp -r /tmp/dracut-ng/modules.d/70dmsquash-live-autooverlay \
